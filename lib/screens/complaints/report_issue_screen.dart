...
import 'package:abans_city_clean_user_app/screens/complaints/map_selection.dart';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: Color(0xFF673AB7).withOpacity(0.8),
                                width: 1),
                          ),
                        ...
                        Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: primaryPurpleColor.withOpacity(0.3),
                                width: 1.5),
                            boxShadow: [
                              BoxShadow(
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                width: double.infinity,
                                height: 1,
                                color: primaryPurpleColor.withOpacity(0.2),
                              ),
                              InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.map_outlined,
                                          color: primaryPurpleColor, size: 22),
                                      SizedBox(width: 12),
                                      Text(
                                        'Select Manually',
                                        style: TextStyle(
                                      ...
                                      Icon(Icons.arrow_forward_ios,
                                          color: primaryPurpleColor, size: 16),
                                    ],
                                  ),
                                ),
                              ),
